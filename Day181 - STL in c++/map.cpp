//stores key-value pair elements for unique keys
//stores in the sorted order of keys
//takes O(logn) time for insertion, deletion, searching of elements
//it uses AVL trees/ red black trees for insertion, searching and deletion of the elements
